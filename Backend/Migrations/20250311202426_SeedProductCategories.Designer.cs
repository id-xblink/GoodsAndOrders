...
namespace GoodsAndOrders.Migrations
{
    ...
    [Migration("20250311202426_SeedProductCategories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.OrderStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.ProductUserOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.UserOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.Product", b =>
                {
                    b.HasOne("GoodsAndOrders.Model.Entities.ProductCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.ProductUserOrder", b =>
                {
                    b.HasOne("GoodsAndOrders.Model.Entities.Product", "Product")
                    ...
                    b.HasOne("GoodsAndOrders.Model.Entities.UserOrder", "UserOrder")
                        .WithMany("OrderElements")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.User", b =>
                {
                    b.HasOne("GoodsAndOrders.Model.Entities.UserRole", "UserRole")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("GoodsAndOrders.Model.Entities.UserOrder", b =>
                {
                    b.HasOne("GoodsAndOrders.Model.Entities.User", "Customer")
                        .WithMany("UserOrders")
                    ...
                    b.HasOne("GoodsAndOrders.Model.Entities.OrderStatus", "OrderStatus")
                        .WithMany("UserOrders")
